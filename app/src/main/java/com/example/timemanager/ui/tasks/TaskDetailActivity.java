...
public class TaskDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        taskList.add(new Task("PROJ01", new Project(11, "Projekt11", "kurzbeschreibung 11", 11.1, "blue"), true).getTaskName());
        taskList.add(new Task("PROJ02", new Project(12, "Projekt12", "kurzbeschreibung 12", 11.1, "blue"), false).getTaskName());
